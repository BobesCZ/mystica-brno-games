...
export class BggVersion {
  ...
  constructor(data: IBggVersion) {
    ...
    this.width = data.width ? Number.parseFloat(data.width?._attributes.value) : undefined;
    this.length = data.length ? Number.parseFloat(data.length?._attributes.value) : undefined;
    this.depth = data.depth ? Number.parseFloat(data.depth?._attributes.value) : undefined;
    this.weight = data.weight ? Number.parseFloat(data.weight?._attributes.value) : undefined;
  }
}
